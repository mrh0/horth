...
public class HorthHeaderBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements HorthHeaderVisitor<T> {
	 ...
	 */
	@Override public T visitOther(HorthHeaderParser.OtherContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitInclude(HorthHeaderParser.IncludeContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
